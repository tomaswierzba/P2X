...
d = alt.Chart(chart_data2).mark_bar().encode(
    ...
    anchor='middle',
    color='#f0f2f6'
).configure_axis(titleColor='#f0f2f6',labelColor='#f0f2f6',labelAngle=0,labelFontSize=15,titleFontSize=15, gridColor='black').add_selection(brush2) #.configure(background='white')
