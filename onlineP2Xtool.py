...
new_title100 = '<p style="font-size:20px;font-weight:600;color:#ffe300> Let''s create more value together, send us an e-mail to <a href = "mailto: abc@example.com">info@hybridgreentech.com</a></p>'
