...
rp=(c1).configure_text(fontSize=25,fontWeight=600).configure_legend(titleFontSize=16, titleFontWeight=600,labelFontSize= 16,labelFontWeight=600, labelAlign='left')
