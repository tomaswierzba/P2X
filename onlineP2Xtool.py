...
d = alt.Chart(chart_data2).mark_bar().encode(
     x='Year:O',y='Non-discounted Cash Flows in Million €:Q',color=alt.condition(brush, alt.value('#ffe300'), alt.value('lightgray')).interactive().properties(
    ...
    anchor='middle',
    color='#f0f2f6'
).configure_axis(titleColor='#f0f2f6',labelColor='#f0f2f6',labelAngle=0,labelFontSize=15,titleFontSize=15, gridColor='black') #.configure(background='white').add_selection(brush)
