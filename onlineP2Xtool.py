...
new_title100 = '<p style="font-size:20px;font-weight:600;color:#ffe300;"><span> Lets create more value together, send us an e-mail to </span><span id="name"; color="#ffe300"><a href = "mailto: info@hybridgreentech.com">info@hybridgreentech.com</a></span></p>'
