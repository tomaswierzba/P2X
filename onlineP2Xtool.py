...
new_title100 = '<p style="font-size:20px;font-weight:600;color:#ffe300; href = "mailto: abc@example.com"> Let''s create more value together, send us an e-mail to <a>info@hybridgreentech.com</a></p>'
