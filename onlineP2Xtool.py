...
new_title100 = '<p style="font-size:20px;font-weight:600;color:#f0f2f6;"><span> Let%'s create more value together, send us an e-mail to </span><span id="name"><a href = "mailto: info@hybridgreentech.com" style="color:#ffe300">info@hybridgreentech.com</a></span></p>'
