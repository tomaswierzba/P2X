...
new_title100 = '<p style="font-size:20px;font-weight:600;color:#ffe300;class=inline> Lets create more value together, send us an e-mail to </p>'
w= '<a href = "mailto: abc@example.com"; class=inline>info@hybridgreentech.com</a>'
st.write(new_title100 + w, unsafe_allow_html=True)
